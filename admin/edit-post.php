...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $status = 1;
        $postid = $_GET['id'];
        $query = mysqli_query($con, "update tblpost set PostTittle='$posttittle',Category='$catid',PostDetail='$postdetail',PostUrl='$url',Is_Active='$status',LastUpBy='$lastuptdby' where id='$postid'");
        if ($query) {
            $msg = "Post updated ";
        } else {
                            ...
                            <div class="card-body">
                                ...
                                <form name="addpost" method="post" enctype="multipart/form-data" class="row g-3 my-2 justify-content-center">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea id="postdescription" name="postdescription" required><?php echo htmlentities($row['PostDetail']); ?></textarea>
                                    </div>
